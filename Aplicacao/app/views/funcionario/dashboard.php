...
<head>
  ...
  <title><?php echo htmlspecialchars($pageTitle ?? 'Dashboard Funcionário — ÂNCORA'); ?></title>
...
<body>
  ...
  <div class="admin-layout-wrapper">
    ...
    <!-- =========================================================================
         1. SIDEBAR LATERAL DO FUNCIONÁRIO
         ========================================================================= -->
    <aside id="admin-sidebar" class="admin-sidebar">
      ...
      <!-- Badge Perfil Funcionário -->
      <div class="sidebar-role-badge funcionario">
      ...
      <div class="sidebar-nav-group">
        ...
        <a href="<?php echo url('funcionario'); ?>" class="sidebar-menu-link active">
      ...
      <div class="sidebar-user-footer">
        <div class="user-footer-profile">
          <div class="user-avatar-circle funcionario"><?php echo htmlspecialchars($userInitials ?? 'FR'); ?></div>
          <div class="user-info-text">
            <span class="user-name-title"><?php echo htmlspecialchars($userName ?? 'Fernanda Rocha'); ?></span>
            <span class="user-role-sub"><?php echo htmlspecialchars($userRole ?? 'Funcionário'); ?></span>
          </div>
        </div>
    ...
    <!-- =========================================================================
         2. CONTEÚDO PRINCIPAL (DASHBOARD DO FUNCIONÁRIO)
         ========================================================================= -->
    <main class="admin-main-content">
      ...
      <!-- =======================================================================
           3. CARDS SUPERIORES DE MÉTRICAS (3 CARDS DO FUNCIONÁRIO)
           ======================================================================= -->
      <div class="metrics-cards-grid cols-3">
        ...
        <!-- Card 2: Itens Encontrados -->
        <div class="metric-card">
          <span class="metric-card-title">Itens Encontrados</span>
          <div class="metric-card-val">0</div>
          <div class="metric-card-icon icon-red">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
          </div>
        </div>
      ...
      <div class="acesso-rapido-grid">
        <!-- Card 1: Registrar (Achados e Perdidos) -->
        <div class="acesso-card">
          <div class="acesso-icon-wrap amber">🔍</div>
          <div>
            <div class="acesso-info-title">Registrar</div>
            <div class="acesso-info-sub">Achados e perdidos</div>
          </div>
        </div>
        ...
        <div class="acesso-card">
          ...
          <div>
            ...
            <div class="acesso-info-sub">Agenda da instituição</div>
          </div>
        </div>
        ...
        <div class="acesso-card">
          ...
          <div>
            ...
            <div class="acesso-info-sub">Ver disponibilidade</div>
          </div>
        </div>
      ...
      <!-- =======================================================================
           6. SEÇÕES INFERIORES: PRÓXIMOS EVENTOS E NOTIFICAÇÕES RECENTES
           ======================================================================= -->
      ...
      <!-- =======================================================================
           7. SEÇÃO ACHADOS E PERDIDOS (CARD INFERIOR DEDICADO)
           ======================================================================= -->
      <div style="margin-top: 20px;">
        <div class="dashboard-section-card">
          <div class="card-header-flex">
            <h3 class="card-header-title">Achados e Perdidos</h3>
            <a href="#" class="card-header-link">Ver todos →</a>
          </div>

          <div class="items-list-vertical">
            <!-- Item 1: carregador -->
            <div class="lost-found-item-row">
              <div class="lost-found-left">
                <div class="lost-found-icon-wrap">
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                </div>
                <div class="lost-found-info">
                  <span class="lost-found-title">carregador</span>
                  <span class="lost-found-sub">Eletrônico</span>
                </div>
              </div>
              <span class="badge-status-pill reivindicado">Reivindicado</span>
            </div>

            <!-- Item 2: Fone de ouvido -->
            <div class="lost-found-item-row">
              <div class="lost-found-left">
                <div class="lost-found-icon-wrap">
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                ...
                <div class="lost-found-info">
                  <span class="lost-found-title">Fone de ouvido</span>
                  <span class="lost-found-sub">Eletrônico</span>
                </div>
              </div>
              <span class="badge-status-pill reivindicado">Reivindicado</span>
