...
<head>
  ...
  <title><?php echo isset($pageTitle) ? $pageTitle : 'Dashboard Administrador — ÂNCORA'; ?></title>
  ...
  <div class="admin-layout-wrapper">
    ...
    <aside id="admin-sidebar" class="admin-sidebar">
      ...
      <div class="sidebar-nav-group">
        ...
        <a href="<?php echo url('admin'); ?>" class="sidebar-menu-link active">
    ...
    <!-- =========================================================================
         2. CONTEÚDO PRINCIPAL (MAIN BODY)
         ========================================================================= -->
    <main class="admin-main-content">
      ...
      <div class="admin-header-row">
        <div>
          <div class="header-date-text">Quarta-Feira, 12 De Agosto</div>
          <h1 class="header-main-title">Olá, <?php echo htmlspecialchars($userName); ?> 👋</h1>
          <div class="header-main-sub"><?php echo htmlspecialchars($userRole); ?> · <?php echo htmlspecialchars($userSector); ?></div>
        </div>
      ...
      <!-- =======================================================================
           3. CARDS SUPERIORES DE MÉTRICAS (5 CARDS)
           ======================================================================= -->
      ...
      <div class="acesso-rapido-grid">
        ...
        <div class="acesso-card">
          <div class="acesso-icon-wrap pink">👥</div>
          <div>
            <div class="acesso-info-title">Usuários</div>
            <div class="acesso-info-sub">Criar e gerenciar</div>
          </div>
        </div>
        ...
        <div class="acesso-card">
          ...
          <div>
            <div class="acesso-info-title">Avisos</div>
            <div class="acesso-info-sub">Notificar usuários</div>
          </div>
        </div>
      </div>
      ...
      <div class="bottom-sections-grid">
        ...
        <div style="display:flex; flex-direction:column; gap:20px;">
          ...
          <!-- Card Parcial: Notificações Recentes -->
          <div class="dashboard-section-card">
            <div class="card-header-flex">
        ...
        <!-- Coluna Direita: Próximos Eventos & Achados e Perdidos -->
        <div style="display:flex; flex-direction:column; gap:20px;">
          ...
          <!-- Card Parcial: Achados e Perdidos -->
          <div class="dashboard-section-card">
            <div class="card-header-flex">
